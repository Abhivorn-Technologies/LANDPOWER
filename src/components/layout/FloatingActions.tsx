  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-center">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="w-12 h-12 rounded-full bg-[#034F90] text-white shadow-xl flex items-center justify-center hover:bg-[#023b6d] hover:scale-110 transition-all border border-white/20 focus:outline-none"
