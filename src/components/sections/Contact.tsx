...
import { Phone, Smartphone, Mail, MapPin, ExternalLink, Send, CheckCircle, Loader2, MessageCircle, FileText, Video, Calendar } from 'lucide-react';
...
const WHATSAPP_URL =
  ...
  encodeURIComponent('Hello LAND POWER, I would like to request complete project PDFs, site videos, location pins, and schedule a site visit.');
    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        const body = encodeURIComponent(
          ...
          `Email: ${currentData.email || 'Not provided'}\n` +
    ...
    <section id="contact" className="py-20 md:py-28 px-4 md:px-8 bg-[#fcf9f8] relative z-0 scroll-mt-24 sm:scroll-mt-28">
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <AnimatedSection direction="up">
          ...
          {/* WhatsApp Direct Request CTA Banner */}
          <div className="mb-8 p-6 bg-[#034F90] text-white rounded-2xl shadow-lg border border-white/10">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-full bg-emerald-500 flex items-center justify-center text-white shrink-0">
                <MessageCircle className="w-6 h-6" />
              </div>
              <h4 className="font-serif text-lg font-bold text-[#ffdea5]">
                {t.contact.whatsappCtaTitle}
              </h4>
            </div>

            <p className="font-sans text-xs sm:text-sm text-[#e5e2e1]/90 mb-4 leading-relaxed">
              {t.contact.whatsappCtaDesc}
            </p>

            <div className="grid grid-cols-2 gap-2 text-xs font-sans text-[#ffdea5] mb-5">
              <div className="flex items-center gap-1.5">
                <FileText className="w-4 h-4 shrink-0" />
                <span>Project PDFs & Drawings</span>
              </div>
              <div className="flex items-center gap-1.5">
                <Video className="w-4 h-4 shrink-0" />
                <span>Site Walk-through Videos</span>
              </div>
              <div className="flex items-center gap-1.5">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 w-full py-3 bg-emerald-500 hover:bg-emerald-600 text-white font-sans text-xs font-bold uppercase tracking-wider rounded-lg transition-all shadow-md"
            >
              <MessageCircle className="w-4 h-4" />
              <span>CHAT ON WHATSAPP (+91 9866387871)</span>
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            ...
            >
              ...
              <p className="font-sans text-sm font-semibold text-[#034F90]">+91-9866387871</p>
            </motion.a>
        ...
        <AnimatedSection delay={0.15} direction="up">
          <div className="bg-[#034F90] p-8 md:p-12 rounded-2xl shadow-2xl text-[#fcf9f8]">
            ...
            <p className="font-sans text-xs sm:text-sm text-[#e5e2e1]/80 mb-6">
            ...
            {submitted ? (
              <div className="py-8 text-center space-y-4">
                ...
                <p className="font-sans text-sm text-[#e5e2e1]/90">
                  Thank you <span className="font-bold text-[#ffdea5]">{submittedData?.firstName}</span>! Our team will contact you shortly with project details.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-5 py-2.5 bg-emerald-500 text-white rounded-lg font-bold text-xs hover:bg-emerald-600 transition-colors flex items-center gap-2"
                  >
                    <MessageCircle className="w-4 h-4" />
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#fcf9f8] text-[#034F90] rounded-lg border-none focus:ring-2 focus:ring-[#ffdea5] p-3.5 text-sm font-sans font-semibold"
                    placeholder="Tell us what you are looking for (Open plots, luxury villas, site visit...)"
                  />
                </div>
